...
namespace Nop.Plugin.Misc.PaymentGuard.Services
{
    public partial class EmailAlertService : IEmailAlertService
    {
        ...
        public async Task SendBlockedScriptAlertAsync(string alertEmail, string scriptUrl, string pageUrl, string storeName)
        {
            ...
            try
            {
                var subject = "PaymentGuard Security Alert - Script Blocked";
                var body = $@"
                    <h2 style='color: #dc3545;'>Security Alert: Script Blocked</h2>
                    ...
                    <table style='border-collapse: collapse; width: 100%;'>
                        <tr>
                            ...
                            <td style='padding: 8px; border: 1px solid #ddd;'>{scriptUrl}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style='padding: 8px; border: 1px solid #ddd;'>{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss} UTC</td>
                        </tr>
                        <tr>
